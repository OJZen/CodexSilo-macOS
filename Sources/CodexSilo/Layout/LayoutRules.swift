...
enum LayoutRules {
    ...
    static let accountEditorContentMaxWidth = CGFloat(760)
    static let accountEditorHorizontalPadding = CGFloat(24)
    static let accountEditorVerticalPadding = CGFloat(20)
    static let accountEditorFooterVerticalPadding = CGFloat(16)
    static let accountEditorSectionSpacing = CGFloat(18)
    static let accountEditorFormLabelWidth = CGFloat(84)
    static let accountEditorFieldSpacing = CGFloat(14)
    static let accountEditorJSONMinHeight = CGFloat(420)
